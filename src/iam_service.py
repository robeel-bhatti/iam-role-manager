...
class IAMService:
    ...
    def create_role(self, role_name: str, policy_doc: str, description: str) -> CreateRoleResponseTypeDef:
    ...
    def attach_inline_policies(self, role_name: str, policy_name: str, policy: str) -> None:
